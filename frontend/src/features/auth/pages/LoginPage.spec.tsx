...
describe('LoginPage', () => {
  ...
  it('submits credentials to /auth/login', async () => {
    (fetch as any).mockResolvedValueOnce(jsonRes(200, { accessToken: 'a', refreshToken: 'r', user: { id: '1', email: 'a@b.com', displayName: 'A', role: 'ADMIN', status: 'ACTIVE', mustChangePassword: false } }));
    renderPage();
    await userEvent.type(screen.getByLabelText('Email'), 'a@b.com');
